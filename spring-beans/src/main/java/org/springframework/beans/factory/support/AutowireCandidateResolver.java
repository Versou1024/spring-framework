...
public interface AutowireCandidateResolver {
	 ...
	 * getLazyResolutionProxyfNecessary(DependencyDescriptor,String):Object 	如果注入点需要，为实际依赖目标的延迟解析构建代理。默认实现只返回null 。
	 ...
	 * isRequired(DependencyDescriptor):boolean 								要进行注入的依赖是否为必要
	 */
